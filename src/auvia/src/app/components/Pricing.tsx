      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="flex items-center justify-center gap-3 mb-12">
          ...
          <Switch
            ...
            checked={!isMonthly}
            onCheckedChange={handleToggle}
            style={{ backgroundColor: !isMonthly ? '#6b8e23' : '#9dbeb9' }}
          />
          <span 
            className="text-sm font-semibold text-slate-700 cursor-pointer"
            onClick={() => { if (isMonthly) handleToggle(true); }}
          >
            Annual <span className="text-[#6b8e23]">(Save 10%)</span>
          </span>
        </div>
          ...
          {plans.map((plan, index) => (
            <motion.div
              ...
              className={cn(
                "relative flex h-full flex-col rounded-[2rem] border bg-white p-8 shadow-sm transition-shadow duration-300 hover:shadow-lg",
                plan.isPopular
                  ? "border-[#6b8e23] ring-2 ring-[#6b8e23]/20 z-10"
                  : "border-slate-200 z-0",
              )}
            >
              {plan.isPopular && (
                <div className="absolute right-4 top-4 flex items-center gap-1 rounded-full bg-[#6b8e23] px-2.5 py-0.5">
                  <Star className="h-3.5 w-3.5 fill-white text-white" />
                  <span className="text-xs font-bold text-white">Most Harmonious</span>
                </div>
              )}
              ...
              <button
                ...
                className={cn(
                  buttonVariants({ variant: "outline" }),
                  "w-full justify-center rounded-full text-sm font-semibold transition-all duration-300",
                  "hover:ring-2 hover:ring-[#6b8e23] hover:ring-offset-1",
                  plan.isPopular
                    ? "bg-[#6b8e23] text-white border-[#6b8e23] hover:opacity-95"
                    : "bg-white text-slate-800 hover:bg-[#6b8e23]/10 hover:text-[#6b8e23] border-[#6b8e23]/20",
                )}
