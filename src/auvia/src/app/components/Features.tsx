...
function FeatureCard({ feature, index }: { feature: any; index: number }) {
  ...
  return (
    <motion.div
      ...
      className="group relative flex min-h-[288px] flex-col rounded-2xl border border-slate-200 bg-white p-7 transition-shadow duration-300 hover:shadow-[0_20px_48px_-12px_rgba(107,142,35,0.18),0_0_0_1.5px_rgba(107,142,35,0.25)]"
    >
      {/* Per-card spotlight */}
      <AnimatePresence>
        {hovered && (
          <motion.div
            ...
            className="pointer-events-none absolute inset-0 rounded-2xl"
            style={{
              background: `radial-gradient(260px circle at ${spotX.get()}% ${spotY.get()}%, rgba(107,142,35,0.10) 0%, transparent 70%)`,
            }}
          />
        )}
      </AnimatePresence>
      ...
      <div className="absolute inset-x-0 top-0 h-[2px] rounded-t-2xl overflow-hidden">
        <motion.div
          className="h-full w-full bg-gradient-to-r from-[#6b8e23]/70 via-[#6b8e23]/50 to-[#6b8e23]"
          initial={{ scaleX: 0, originX: 0 }}
          whileInView={{ scaleX: 1 }}
          viewport={{ once: true }}
          transition={{ duration: 0.7, delay: index * 0.08 + 0.3, ease: [0.22, 1, 0.36, 1] }}
      ...
      {/* Icon */}
      <div
        className="mb-6 inline-flex items-center justify-center rounded-xl border border-[#6b8e23]/20 bg-[#6b8e23]/10 p-3 transition-all duration-300 group-hover:border-[#6b8e23]/30 group-hover:bg-[#6b8e23]/20"
        style={{ transform: "translateZ(20px)" }}
      >
        <Icon className="size-[18px] text-[#6b8e23]" />
      </div>
      ...
      {/* Badge */}
      <span className="mt-auto inline-flex w-fit items-center gap-1.5 rounded-full border border-[#6b8e23]/20 bg-[#6b8e23]/10 px-3 py-1 text-[10px] font-bold tracking-widest text-[#6b8e23]">
        <span className="size-1.5 rounded-full bg-[#6b8e23] inline-block" />
        {feature.badge}
      </span>
    </motion.div>
  );
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="pointer-events-none absolute inset-0 -z-0 rounded-3xl"
        style={{
          background: `radial-gradient(500px circle at ${springX.get()}px ${springY.get()}px, rgba(107,142,35,0.07) 0%, transparent 60%)`,
        }}
      />
      <div className="relative z-10 grid gap-5 md:grid-cols-2 lg:grid-cols-3">
        {children}
  ...
  return (
    <>
      ...
      <section id="features" className="feat-root relative overflow-hidden bg-white px-6 py-28">
        ...
        {/* Background texture blobs */}
        <div className="pointer-events-none absolute inset-0 overflow-hidden">
          <div className="absolute -top-24 right-0 size-[480px] rounded-full bg-[#6b8e23]/10 blur-[96px] opacity-70" />
          <div className="absolute bottom-0 left-10 size-[360px] rounded-full bg-[#6b8e23]/10 blur-[80px]" />
        </div>
        ...
        <div className="relative mx-auto max-w-7xl">
          ...
          >
            <div className="max-w-2xl">
              {/* Eyebrow */}
              <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-[#6b8e23]/20 bg-[#6b8e23]/10 px-3 py-1.5">
                <span className="size-1.5 rounded-full bg-[#6b8e23] animate-pulse inline-block" />
                <span className="text-[11px] font-semibold text-[#6b8e23] tracking-wide">PLATFORM CAPABILITIES</span>
              </div>

              <h2 className="feat-serif text-[2.6rem] font-normal leading-[1.08] text-slate-900 sm:text-[3.2rem] md:text-[3.8rem]">
                Precision Engineering<br />
                <span className="italic text-[#6b8e23]">for Modern Clinics</span>
              </h2>
            ...
            <motion.a
              ...
              whileHover={{ x: 4 }}
              transition={{ type: "spring", stiffness: 300 }}
              className="feat-root group inline-flex items-center gap-2 text-[15px] font-semibold text-[#6b8e23] hover:text-[#55711c] transition-colors shrink-0 mb-1"
            >
              View all features
              <ArrowRight className="size-4 transition-transform group-hover:translate-x-1" />
            </motion.a>
